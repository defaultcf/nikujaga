...
class DishesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'imgname' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-07-03 03:32:13',
            'modified' => '2017-07-03 03:32:13'
        ],
    ];
}
